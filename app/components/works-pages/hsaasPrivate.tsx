...
export default function HsaasPrivate() {
    ...
    <div className="bg-white min-h-screen mt-16 px-4 md:px-0">
      ...
      <div className="relative overflow-visible max-w-5xl mx-auto border-l border-r border-t border-gray-200">
        ...
        <div className="relative overflow-visible flex items-center justify-between px-6 md:px-10 py-4 border-b border-gray-200 bg-white">
          ...
          >
            <Image src="/images/WorkImages/hsaasImages/hs-mark.svg" alt="Blume Health" width={28} height={28} className="w-6 h-6 md:w-7 md:h-7 object-contain" style={{ filter: 'brightness(0) invert(1)' }} />
          </div>
        ...
        <div className="relative overflow-visible border-b border-gray-200">
          ...
          <div className="relative border-t border-gray-200">
            ...
            <div ref={reviewScrollRef} className="overflow-x-hidden" style={{ scrollbarWidth: 'none' }}>
              <div className="flex">
                <Image src="/images/WorkImages/hsaasImages/hs-profile-3.png" alt="Blume Health profile review" width={1200} height={800} className="h-auto block w-full flex-shrink-0" />
                <Image src="/images/WorkImages/hsaasImages/hs-profile-4.png" alt="Blume Health profile submitted" width={1200} height={800} className="h-auto block w-full flex-shrink-0" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div id="bh-logo" className="relative overflow-visible border-b border-gray-200">
          <Image
            src="/images/WorkImages/hsaasImages/hs-mx.png"
            alt="Blume Health"
            width={2000}
            height={1200}
            className="w-full h-auto object-cover"
